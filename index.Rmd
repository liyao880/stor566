...
|Sep. 09| Convolutional Neural Networks II ||ResNet |
|Sep. 11| Recurrent Neural Networks || |
|Sep. 16| GRU and LSTM || |
|Sep. 18| NLP Pre-training || Word2Vec|
|Sep. 23| Project Proposal Discussion || |
|Sep. 25| Project Proposal Discussion || |
|Sep. 30| Transformer || |
|Oct. 02| Vision Transformer ||BERT |
|Oct. 07| Well-Being Day || |
|Oct. 09| Generative Models I || |
|Oct. 14| Generative Models II ||DDPM |
|Oct. 16| Fall Break || |
|Oct. 21| Generative Models III ||CLIP |
|Oct. 23| Adversarial Attack || |
|Oct. 28| Adversarial Defense || |
|Oct. 30| Poisoning Attack || |
|Nov. 04| Poisoning Defense  || |
|Nov. 06| Explainable AI || |
|Nov. 11| Large Language Models || |
|Nov. 13| Mutimodal LLM || Mini GPT4 |
|Nov. 18| LLM Security || Jailbreak|
